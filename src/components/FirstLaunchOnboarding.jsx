...
const SLIDES = [
  {
    ...
    body: 'Nova ve tu calendario, sugiere cómo organizarlo mejor, y nunca toca nada sin que vos lo apruebes.',
  },
  {
    id: 'planner',
    ...
    body: 'Eventos, tareas y bloques de foco en la misma línea de tiempo. Ves qué sigue y qué podés mover.',
  },
  {
    id: 'tasks',
    ...
    body: 'Lo que querés hacer y el tiempo para hacerlo, en el mismo lugar. Nova también te recuerda los dos.',
  },
  {
    id: 'nova',
    illustration: <SlideIllustrationNova />,
    eyebrow: 'Nova',
    title: 'Propone. Tú decidís.',
    body: 'Cuando hay un conflicto o un hueco, Nova manda una propuesta a tu bandeja. Aprobás con un tap — o la descartás.',
  },
  {
    id: 'start',
    ...
    body: 'Añadí una tarea o evento, o pedile a Nova que proponga un bloque de foco. Tu día arranca acá.',
    cta: 'Empezar',
  },
]
    ...
    >
      ...
      <div className="relative z-10 flex items-center justify-between px-5 pt-4">
        ...
        {!isLast && (
          <button
            onClick={finish}
            className="rounded-full px-3 py-1 text-[12px] font-semibold text-white/55 transition-colors hover:text-white/85"
          >
            Saltar
          </button>
        )}
