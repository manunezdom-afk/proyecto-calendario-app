    ...
    <AnimatePresence>
      {isOffline && (
        <motion.div
          ...
          className="fixed top-0 inset-x-0 z-[90] bg-amber-500 text-white text-[12px] font-semibold py-2 px-3 flex items-center justify-center gap-2 shadow-md"
        >
      ...
      {!isOffline && justReconnected && (
        <motion.div
          ...
          className="fixed top-0 inset-x-0 z-[90] bg-emerald-500 text-white text-[12px] font-semibold py-2 px-3 flex items-center justify-center gap-2 shadow-md"
        >
