...
export default function BottomNavBar({ activeView, onNavigate }) {
  ...
  return (
    <nav className="fixed bottom-safe-bottom left-1/2 -translate-x-1/2 w-[92%] rounded-[24px] z-50 flex justify-around items-center px-4 py-3 bg-slate-50/70 backdrop-blur-2xl shadow-[0_12px_32px_rgba(0,0,0,0.06)]">
